...
public class NfcCardReader implements NfcAdapter.ReaderCallback {
    ...
    private static final String SAMPLE_NFC_CARD_AID = "00A4040007A000000247100106";
    ...
    public NfcCardReader(@Nullable AccountCallback accountCallback) {
    ...
    public void onTagDiscovered(@Nullable Tag tag) {
        ...
        if (isoDep != null) {
            try {
                ...
                byte[] command = HexStringToByteArray(SAMPLE_NFC_CARD_AID);
